...
import { SHA256, createSeminarData, editSeminarData, getSeminarData } from "../../firebase";

function EditSeminarData() {
    ...
    useEffect(()=>{
        ...
        .then(data => {
            ...
            setUploadedAttachs(data.attachments);
            if(data.assign !== null){
                setAssignment(true);
                setDate(data.assign.deadline);
            }
        })
    }, []);
    ...
    const uploadData = () => {
        ...
        setStatus(1);
        editSeminarData(getParameter("id"), attachs, {
            title: title,
            content: content,
...
export default EditSeminarData;